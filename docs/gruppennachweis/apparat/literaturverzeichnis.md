...
Im dokumentierten Bearbeitungszeitraum liegen **keine externen Fachliteraturquellen** vor. Die fachlichen Begründungen im Gruppennachweis stützen sich bislang auf:
...
| Nr. | Autor(en) | Jahr | Titel | Quelle | Verwendet in |
|---|---|---|---|---|---|
| [OFFEN] | — | — | Empowerment in der (Heil-)Pädagogik | — | Kapitel 1, 4 |
| [OFFEN] | — | — | Partizipation / Selbstbestimmung | — | Kapitel 4 |
| [OFFEN] | — | — | ICF-CY – Klassifikation und Anwendung | — | Kapitel 3 |

## Methodische Grundlagen

| Nr. | Autor(en) | Jahr | Titel | Quelle | Verwendet in |
|---|---|---|---|---|---|
| [OFFEN] | — | — | Beobachtung und Dokumentation in pädagogischen Settings | — | Kapitel 2, 3, 5, 6 |
