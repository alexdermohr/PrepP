...
- Projektplan: `docs/projektplan.md` → Ausgangslage, Förderbedarf, Ressourcen, Interessen
- Projektziel: `meta/projektziel.md` → Nachvollziehbarkeit, Reflexion, Explizitmachung
- Beobachtungen: `docs/beobachtungen/01_verhalten_in_situationen.md` → Verhaltensmuster als Ausgangspunkt

## Kernaussagen (zu verdichten)

- X zeigt unterschiedliches Verhalten in handlungsorientierten vs. sozial exponierten Situationen
  → Quelle: `docs/beobachtungen/01_verhalten_in_situationen.md`
