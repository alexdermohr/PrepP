# Mapping: Rohmaterial → Gruppennachweis-Kapitel

## Zweck

Dieses Dokument stellt sicher, dass jede Aussage im Gruppennachweis auf eine Quelle im Rohmaterial zurückgeführt werden kann.
...
| Funktionsprofile P1–P5 (Verdichtung) | `docs/beobachtungen/*.md`, `docs/tagebuch/*.md`, `docs/hypothesen.md` (H1, H2, H4, H6, H8, H9, H11) | strukturiert |
...
| Aussage / Inhalt | Quelle (Rohmaterial) | Status |
|---|---|---|
| Übergeordnetes Ziel und Teilziele T1–T5 mit Evidenzkriterium | `docs/projektplan.md` | strukturiert |
...
| Fachliche Begründung (Wirkindikator + Gegenerklärung je Maßnahme) | `docs/hypothesen.md`, `models/prep_planung.md`, `docs/intervention/pause_protokoll.md` | strukturiert |
