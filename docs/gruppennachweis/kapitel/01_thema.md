...
> Es zeigt, warum eine handlungsnahe Mitwirkungsrolle zu X passt
...
**„Schulhof verschönern mit X"** – ein schulisches Gemeinschaftsprojekt, in dem der zieldifferent beschulte Siebtklässler X als zentrale beteiligte Person in einem realen Gestaltungsvorhaben mitwirkt; die anfangs größer gedachte Leitungsrolle wurde im Verlauf schrittweise reduziert.
→ Quelle: [docs/projektplan.md](../../projektplan.md) (Titel, Übergeordnetes Ziel)

## 1.2 Kurzbeschreibung

Im Projektverlauf durchläuft X mit zwei Pädagogen (T. und A.) und zeitweise kooperierenden Mitschülern – insbesondere Y – die Phasen Planung, Schulhofumfrage, konkrete Umsetzungsplanung, Materialbeschaffung und Reflexion. Kern der Umsetzung ist bislang ein einzelner Pfandmülleimer in der Insel als erster sichtbarer Beitrag des Pfandprojekts.
...
- X zeigt in handlungsorientierten Situationen (Pfand sammeln, Preise vergleichen, Rechnen) Initiative, Ausdauer und Selbstständigkeit.
...
4. **Fachliche Rahmung.** Die Planungslogik entspricht dem Rahmenmodell „Prep-Planung" (Förderbedarf + Interessen + Ressourcen → Aktivität mit Partizipation und Rückmeldung unter dem Prinzip Empowerment).
